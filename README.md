...
Can you find a mathematic equation that can describe the sorrow of a man just lost his lover?

Can you find a mathematic equation that can describe the moment when Beethoven is composing ``Symphony of Fate''?
...
##### Real Deep Model is the model of human being's deep consciousness. 
There is also a surface model, which represent human being's consciousness model. They all use language. Everyone has a unique pattern when building deep model from their experience in the real world. That pattern can be extracted by neuro-linguistic programming, and expressed by formal first-order logic into a model. This model is the model of model, thus, meta model. As the models of human conscious and sub-consciousness are expressed with language, it can also be called language model, thus, LLM.
